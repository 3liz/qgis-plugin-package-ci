...
__version__ = version("qgis-plugin-package-ci")
__title__ = "QGISPluginPackageCI"
...
def cli():
    ...
    release_parser.add_argument(
        "--osgeo-username",
        help="The Osgeo user name to publish the plugin."
    )
    release_parser.add_argument(
        "--osgeo-password",
        help="The Osgeo password to publish the plugin."
    )

    release_parser.add_argument("--dry-run", help="Dry run", action="store_true")
    release_parser.add_argument(
        "--no-diff-check",
        help="Do not check diff",
        action="store_true",
